...
export default function EmbedPdfViewer({ readOnly = false }: EmbedPdfViewerProps) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight">
              {readOnly ? "EmbedPDF Viewer (Read-Only)" : "EmbedPDF Viewer Workspace"}
            </h1>
            ...
            <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                ...
                <div className="text-center">
                  <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100">Upload PDF</h3>
              ...
              <div className="p-8 border border-zinc-200 dark:border-zinc-800 rounded-2xl bg-white dark:bg-zinc-900 shadow-md flex flex-col justify-between gap-5">
                ...
                <div className="flex flex-col gap-2">
                  <span className="text-[10px] font-semibold uppercase tracking-wider text-zinc-400">PDF Presets:</span>
                  <div className="grid grid-cols-2 gap-2">
                    {PRESETS.map((preset) => (
                      ...
                      >
                        <span className="text-[10px] font-bold text-zinc-800 dark:text-zinc-200 line-clamp-1">{preset.name}</span>
                        <span className="text-[8px] text-zinc-500 dark:text-zinc-400 line-clamp-1 leading-none">{preset.description}</span>
                      </button>
                    ))}
                  </div>
                </div>
              ...
              <div className="flex-1 p-4 flex justify-center items-stretch min-h-0 relative">
                <div className="relative shadow-lg border border-zinc-200 dark:border-zinc-800 bg-white rounded flex-1 flex flex-col overflow-hidden">
                  <PDFViewer
                    config={{
                      src: fileUrl,
                      disabledCategories: readOnly ? ["annotation", "print", "export", "download", "redaction", "form", "insert", "document"] : [],
                    }}
